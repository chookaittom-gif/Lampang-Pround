...
### Shop Report (PDF)
- รายงานรายร้านกระดาษ A4 (`worker/src/routes/pdf.ts`) คือร่างพิมพ์ของระบบตัวอักษรเดียวกัน: ฟอนต์ Sarabun แทน Prompt (งานพิมพ์ราชการ), ตารางขอบ `TABLE_BORDER` บนพื้น `TABLE_HEADER_BG` (#dbeafe เทียบเท่า primary-tint) และ `LABEL_BG` (#f8fafc เทียบเท่า surface-tint)
- ตารางสินค้าแถวสูงตามเนื้อหาจริง (ขั้นต่ำ 56pt) ข้อความ wrap สูงสุด 4 บรรทัด ไม่ตัดข้อมูลทิ้ง, รูปประจำสินค้าฝังในเซล, กริดรูปชิดล่างเซลให้ท้องรูปเสมอกันพร้อมคำบรรยายกลาง
- กฎการพิมพ์: หัวข้อห้ามค้างท้ายหน้า (จองที่ทั้งก้อนก่อนวาด), หมวดรูปต่อหน้าเดียวกับตารางถ้าที่พอ
